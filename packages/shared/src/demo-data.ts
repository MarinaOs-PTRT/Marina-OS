...
export const CLIENTI_DEMO: Client[] = [
  {
    ...
    posto: 'C 1', pontile: 'Pontile Charlie', catPosto: 'Cat. IV', dimMax: 'max 15,5m × 4,5m', azioni: '620'
  },
  {
  ...
  },
  {
    ...
    posto: 'B 14', pontile: 'Pontile Bravo', catPosto: 'Cat. II', dimMax: 'max 9m × 3,25m', azioni: '310'
  },
  {
  ...
  },
  {
    ...
    posto: 'G 8', pontile: 'Pontile Golf', catPosto: 'Cat. II', dimMax: 'max 10m × 3,5m', azioni: '340'
  }
]

// ── BARCHE ──
export const BARCHE_DEMO: Boat[] = [
  { id: 1, clientId: 1, nome: 'Chaya', matricola: 'IT-RM-2847', tipo: 'Motore', lunghezza: 12.5, larghezza: 4.2, pescaggio: 1.8, posto: 'C 1', bandiera: 'Italia', stato: 'occupato_socio' },
  { id: 2, clientId: 2, nome: 'S/V Tramontana', matricola: '247654321', tipo: 'Vela', lunghezza: 13.8, larghezza: 4.1, pescaggio: 1.9, posto: 'C 4', bandiera: 'Italia', stato: 'occupato_transito' },
  { id: 3, clientId: 3, nome: 'M/Y Neptune Dream', matricola: '123456789', tipo: 'Motore', lunghezza: 28, larghezza: 7.2, pescaggio: 2.1, posto: 'TW 3', bandiera: 'Regno Unito', stato: 'occupato_affittuario' },
  ...
  { id: 5, clientId: 4, nome: 'M/Y Albatros', matricola: '247123456', tipo: 'Motore', lunghezza: 10.5, larghezza: 3.4, pescaggio: 1.2, posto: 'B 14', bandiera: 'Italia', stato: 'occupato_socio' },
...
export const POSTI_DEMO: Berth[] = [
  { id: 'C 1', pontile: 'Pontile Charlie', lato: 'Sinistro', lunMax: 15.5, larMax: 4.5, profondita: 3.5, categoria: 'Cat. IV', stato: 'occupato_socio', barcaOra: 'Chaya', socioId: 1 },
  { id: 'B 14', pontile: 'Pontile Bravo', lato: 'Destro', lunMax: 9, larMax: 3.25, profondita: 2.5, categoria: 'Cat. II', stato: 'occupato_socio', barcaOra: 'M/Y Albatros', socioId: 4 },
  ...
  { id: 'G 8', pontile: 'Pontile Golf', lato: 'Sinistro', lunMax: 10, larMax: 3.5, profondita: 2.8, categoria: 'Cat. II', stato: 'socio_assente', barcaOra: 'Socio assente', socioId: 7 },
  { id: 'TW 3', pontile: 'Transito West', lato: 'Destro', lunMax: 30, larMax: 8.0, profondita: 5.0, categoria: 'Cat. VII', stato: 'occupato_transito', barcaOra: 'M/Y Neptune Dream' },
  { id: 'C 4', pontile: 'Pontile Charlie', lato: 'Sinistro', lunMax: 15.5, larMax: 4.5, profondita: 3.5, categoria: 'Cat. IV', stato: 'occupato_transito', barcaOra: 'S/V Tramontana' },
  { id: 'C 24', pontile: 'Pontile Charlie', lato: 'Destro', lunMax: 15.5, larMax: 4.5, profondita: 3.5, categoria: 'Cat. IV', stato: 'libero' }
]

// ── MOVIMENTI ──
export const MOVIMENTI_DEMO: Movement[] = [
  { id: 1, ora: '07:30', nome: 'M/Y Neptune Dream', matricola: '123456789', tipo: 'entrata', posto: 'TW 3', scenario: 'affittuario', auth: true, pagamento: 'Autorizzato', note: 'Arrivo da Napoli · autorizzazione verificata', operatore: { nome: 'Mario Rossi', ruolo: 'Operatore Torre', iniziali: 'MR' } },
  { id: 2, ora: '08:15', nome: 'M/Y Rex', matricola: '247881234', tipo: 'uscita', posto: 'B 22', scenario: 'socio', auth: false, pagamento: 'Titolo Attivo', note: 'Uscita temporanea', operatore: { nome: 'Mario Rossi', ruolo: 'Operatore Torre', iniziali: 'MR' } },
  { id: 3, ora: '09:30', nome: 'S/V Libeccio', matricola: '247999222', tipo: 'spostamento', posto: 'E 12', scenario: 'transito', auth: true, origine: 'E 4', destinazione: 'E 12', pagamento: 'Pagato', note: 'Spostamento richiesto', operatore: { nome: 'Lara Conti', ruolo: 'Operatore Torre', iniziali: 'LC' } },
  { id: 4, ora: '09:51', nome: 'Chaya', matricola: 'IT-RM-2847', tipo: 'entrata', posto: 'C 1', scenario: 'transito', auth: false, pagamento: 'Da pagare', note: 'Primo arrivo', operatore: { nome: 'Mario Rossi', ruolo: 'Operatore Torre', iniziali: 'MR' } },
  { id: 11, ora: '16:00', nome: 'M/Y Perseo', matricola: '247667788', tipo: 'cantiere', posto: 'A 3', scenario: 'socio', auth: false, origine: 'D 12', destinazione: 'A 3', pagamento: 'Titolo Attivo', note: 'Alaggio per manutenzione scafo', operatore: { nome: 'Giulia Marin', ruolo: 'Operatore Torre', iniziali: 'GM' } }
]
...
export const RICEVUTE_DEMO: Receipt[] = [
  { numero: '2026/0041', data: '2026-04-20', nomeBarca: 'M/Y Neptune Dream', matricola: '123456789', posto: 'TW 3', periodo: '17/04/2026 – 20/04/2026', giorni: 3, categoria: 'Cat. VII', tariffa: 320, extra: 0,  totale: 960,  metodo: 'pos',      operatore: 'Mario Rossi' },
  { numero: '2026/0042', data: '2026-04-21', nomeBarca: 'S/V Tramontana',    matricola: '247654321', posto: 'C 4', periodo: '18/04/2026 – 21/04/2026', giorni: 3, categoria: 'Cat. IV', tariffa: 90,  extra: 15, totale: 285,  metodo: 'contante', operatore: 'Lara Conti' },
  { numero: '2026/0043', data: '2026-04-22', nomeBarca: 'S/V Libeccio',      matricola: '247999222', posto: 'E 12',periodo: '20/04/2026 – 22/04/2026', giorni: 2, categoria: 'Cat. IV', tariffa: 90,  extra: 0,  totale: 180,  metodo: 'pos',      operatore: 'Mario Rossi' },
  { numero: '2026/0044', data: '2026-04-22', nomeBarca: 'M/Y Rex',           matricola: '247881234', posto: 'B 22',periodo: '21/04/2026 – 22/04/2026', giorni: 1, categoria: 'Cat. II', tariffa: 50,  extra: 0,  totale: 50,   metodo: 'contante', operatore: 'Giulia Marin' },
]

// ── MANUTENZIONI SUBACQUEE ──
export const MANUTENZIONI_DEMO: MaintenanceJob[] = [
  { id: 1, berthCodice: 'C 1', tipoLavoro: 'Sostituzione catenaria principale', descrizione: 'Catenaria corrosa, sostituzione urgente prima della stagione', urgenza: 'urgente', stato: 'dafare', origine: 'socio', clientId: 1, assegnatoA: 'Reparto subacquei', dataPrevista: '2026-04-23' },
  ...
  { id: 3, berthCodice: 'E 8', tipoLavoro: 'Rimozione cima attorcigliata elica', descrizione: 'Cima intrappolata nell\'elica del posto E 8, barca impossibilitata a uscire', urgenza: 'urgente', stato: 'incorso', origine: 'socio', clientId: 5, assegnatoA: 'Reparto subacquei', dataPrevista: '2026-04-22' },
...
export const SEGNALAZIONI_DEMO: Report[] = [
  ...
  { id: 3, zona: 'Pontile Charlie — radice', tipoProblema: 'Banchina/pavimentazione', descrizione: 'Tavola di legno del camminamento rotta, rischio inciampo', urgenza: 'normale', stato: 'dafare', canale: 'ispezione', assegnatoA: 'esterno', origine: 'direzione', dataSegnalazione: '2026-04-20' },
  ...
  { id: 5, zona: 'Pontile Golf — testata', tipoProblema: 'Illuminazione pontile', descrizione: 'Faro di testata pontile intermittente', urgenza: 'normale', stato: 'dafare', canale: 'di_persona', assegnatoA: 'manutenzione', origine: 'torre', dataSegnalazione: '2026-04-22' }
]
...
export const TITOLI_POSSESSO_DEMO: OwnershipTitle[] = [
  { id: 1, clientId: 1, berthId: 'C 1', numero: 'PTRT-2015-0102', dataAcquisizione: '2015-04-10', azioni: 620, catAzioni: 'A', canone: 'Regolare', scadenzaCanone: '2027-01-31' },
  ...
  { id: 3, clientId: 4, berthId: 'TW 3', numero: 'PTRT-2020-0891', dataAcquisizione: '2020-02-15', azioni: 1200, catAzioni: 'S', canone: 'Regolare', scadenzaCanone: '2027-01-31' }
]

// -- AUTORIZZAZIONI (M-07) --
export const AUTORIZZAZIONI_DEMO: Authorization[] = [
  { id: 1, socioId: 1, berthId: 'C 1', tipo: 'affitto', beneficiario: 'Luigi Verdi (PF)', barca: 'S/V Tramontana', matricola: 'IT-NA-1122', tel: '+39 340 1234567', dal: '2026-04-01', al: '2026-09-30', giorniResidui: 161, stato: 'attiva', authDa: 'Direzione' },
  ...
  { id: 3, socioId: 4, berthId: 'TW 3', tipo: 'amico', beneficiario: 'Elena Bianchi', barca: 'S/V Vento', matricola: 'NL-4521-T', tel: '+39 320 1122334', dal: '2026-03-01', al: '2026-03-15', giorniResidui: 0, stato: 'scaduta', authDa: 'Direzione' }
]
